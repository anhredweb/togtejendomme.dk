...
class FAQBookProViewArticles extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		{
			FAQBookProHelper::addSubmenu('articles');
		}
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_FAQBOOKPRO_ARTICLES_TITLE'), 'article.png');

		if ($canDo->get('core.create') || (count($user->getAuthorisedCategories('com_faqbookpro', 'core.create'))) > 0 )
		{
		...
		// Add a batch button
		if ($user->authorise('core.create', 'com_faqbookpro') && $user->authorise('core.edit', 'com_faqbookpro') && $user->authorise('core.edit.state', 'com_faqbookpro'))
		{
		...
		/*JHtmlSidebar::setAction('index.php?option=com_faqbookpro&view=articles');
