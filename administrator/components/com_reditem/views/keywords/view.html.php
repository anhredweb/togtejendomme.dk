 ...
 * @since       0.9.1
 */
class ReditemViewKeywords extends ReditemView
{
	/**
	...
	{
		return JText::_('COM_REDITEM_KEYWORD_KEYWORDS');
	}
	...
	public function getToolbar()
	{
		...
		{
				$new = RToolbarBuilder::createNewButton('keyword.add');
				$secondGroup->addButton($new);

				$edit = RToolbarBuilder::createEditButton('keyword.edit');
				$secondGroup->addButton($edit);

				$delete = RToolbarBuilder::createDeleteButton('keywords.delete');
