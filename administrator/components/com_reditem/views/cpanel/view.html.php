 ...
 * @since       0.9.1
 */
class RedItemViewCpanel extends ReditemView
{
	/**
	...
	public function display($tpl = null)
	{
		...
		$this->iconArray = ReditemHelperCpanelIcons::getIconArray();
	...
	public function renderCpanelIconSet($iconArray = array(), $quickLinkIcons = null)
	{
		...
		foreach ($iconArray as $icon)
		{
			...
			$link = 'index.php?option=com_reditem&amp;view=' . $icon['name'];

			$this->quickiconButton($link, $icon['icon'], JText::_("COM_REDITEM_CPANEL_" . $icon['title'] . '_LABEL'));
		...
		{
			echo JText::_("COM_REDITEM_CPANEL_NO_ACCESS_DESC");
		}
	}
