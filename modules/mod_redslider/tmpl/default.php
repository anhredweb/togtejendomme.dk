...
echo '<script type="text/javascript">
		...
		bxslider = j(".bxslider_' . $module->id . '").bxSlider({
			' . $strSlideWidth . '
			...
			onSlideNext: function(){
				if(thumbnail)
				{
					j(".gallery_' . $module->id . ' .slide a[data-slide-index=\"" + curSlideIdx + "\"] img").css("border", "3px solid transparent");
					curSlideIdx ++;
					if(curSlideIdx == bxslider.getSlideCount())
					{
						curSlideIdx = 0;
					}
					j(".gallery_' . $module->id . ' .slide a[data-slide-index=\"" + curSlideIdx + "\"] img").css("border", "3px solid red");
	    ...
	    gallery = j(".gallery_' . $module->id . '").bxSlider({
	        ...
	        onSliderLoad: function(){
				j(".gallery_' . $module->id . ' .slide a img").css("border", "3px solid transparent");
				j(".gallery_' . $module->id . ' .slide a[data-slide-index=\"0\"] img").css("border", "3px solid red");
			},
	        onSlideNext: function(){
	    ...
	    j(".gallery_' . $module->id . ' .slide a").click(function(){
		    j(".gallery_' . $module->id . ' .slide a[data-slide-index=\"" + curSlideIdx + "\"] img").css("border", "3px solid transparent");
